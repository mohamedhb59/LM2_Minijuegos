...
function identificar(datos) {
  ...
  for (i in secuenciaHumano) {
    if (secuenciaHumano[i] != maquina[i]) resultado = false;
  }
...
function escogerColor(id) {
  var color;
  if (id == "rojo") color = "#F00";
  else if (id == "azul") color = "#00F";
  else if (id == "amarillo") color = "#FFFF00";
  else if (id == "verde") color = "#0F0";
